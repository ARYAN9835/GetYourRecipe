...
const Quiz1 = () => {
    ...
    const handleAnswerClick = (answer) => {
        ...
        if (answer === quizData.Nutrition[currQuestion].answer) {
            setScore(score + 1);
        }

        if (currQuestion < quizData.Nutrition.length - 1) {
        ...
        <div className='quiz'>
            {showScore ? (
                <div className='scoreSection'>
                    <p>You scored {score} out of {quizData.Nutrition.length}.</p>
                    <ul>
                        {quizData.Nutrition.map((question, index) => (
                ...
                <div className='quizSection'>
                    ...
                    <div className='question-text'>
                        {quizData.Nutrition[currQuestion].question}
                    </div>
                    <div className='question-options'>
                        {quizData.Nutrition[currQuestion].options.map((option, index) => (
                            <button
                                key={index}
                    ...
                    <div className='check-score'>
                        {currQuestion === quizData.Nutrition.length - 1 && (
